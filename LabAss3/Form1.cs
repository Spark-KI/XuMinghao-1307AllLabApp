...
namespace LabAss3
{
    public partial class frmCustomerDataEntry : Form
    {
        ...
        {
            SqlConnection objConnection = new SqlConnection("Data Source=DESKTOP-6BLL5M4;Initial Catalog=CustomerDB;Persist Security Info=True;User ID=sa;Password=123456;Pooling=False");
            objConnection.Open();
